...
const CancellationPolicy = () => {
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        setLoading(true);
        const response = await instance.get('/api/pages/Cancellation Policy');
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-red-500 to-pink-500 px-8 py-12 text-center">
            ...
            <p className="text-red-100 text-lg">Clear guidelines for order cancellations</p>
          </div>
          ...
          <div className="px-8 py-10">
            {content ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-500 text-lg">No content available for Cancellation Policy</p>
              </div>
            )}
          </div>
