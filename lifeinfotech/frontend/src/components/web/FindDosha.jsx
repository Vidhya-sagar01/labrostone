...
const FindDosha = () => {
  ...
  const yogaBanner = "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&w=1200&q=80";
  const ayurvedaBanner = "https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?auto=format&fit=crop&w=1200&q=80";
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24 max-w-7xl mx-auto">
          ...
          <div className="w-full lg:w-1/2 text-left space-y-10">
            ...
            <p className="text-slate-500 text-xl font-medium leading-relaxed max-w-md">
              Discover which <b>Lebrostone</b> essentials are made for your unique skin type.
            </p>
