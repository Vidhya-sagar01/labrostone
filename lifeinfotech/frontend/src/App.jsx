...
function App() {
  ...
  return (
    <Routes>
      ...
      {/* 2. AUTH ROUTES */}
      <Route path="/login" element={isUserAuthenticated ? <Navigate to="/" replace /> : <SignInogin />} />
      <Route path="/signup" element={isUserAuthenticated ? <Navigate to="/" replace /> : <SignUplogin />} />
      
      {/* 3. USER PROTECTED ROUTES */}
      <Route path="/profile" element={isUserAuthenticated ? <><Navbar /><UserProfile /><Footer /></> : <Navigate to="/login" />} />
      <Route path="/cart" element={isUserAuthenticated ? <><Navbar /><Cart /><Footer /></> : <Navigate to="/login" />} />
      <Route path="/checkout" element={isUserAuthenticated ? <><Navbar /><Checkout /><Footer /></> : <Navigate to="/login" />} />

      {/* 4. PRODUCT ROUTES */}
      <Route path="/product/:id" element={<><Navbar /><ProductDetail /><Footer /></>} />
      <Route path="/collections/:categoryId" element={<><Navbar /><AllProductByCategory /><Footer /></>} />
      <Route path="/shop/category/:categoryId" element={<><Navbar /><AllProductByCategory /><Footer /></>} />

      {/* 5. ADMIN LOGIN */}
      <Route path="/admin/login" element={isAdminAuthenticated ? <Navigate to="/admin/dashboard" replace /> : <Login />} />
        ...
        <ProtectedRoute>
          <AdminLayout>
            <Routes>
              ...
              <Route path="season" element={<Season />} /> {/* Season is your Add Combo Page */}
